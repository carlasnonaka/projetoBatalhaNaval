...
public class Partida {
 ...
 int placarPessoa = 0;
    ...
    public int verificarJogada(String jogada, String nomeJogador, String[][] tabuleiro1, String[][] tabuleiro2, Tabuleiro tabuleiro) {
       ...
       try {
        ...
        tabuleiro.imprimeTabuleiro(tabuleiro1, nomeJogador);
