...
public class Main {
       ...
       public static void main(String[] args) {
        ...
        while (!existeGanhador){
         ...
         placarPessoa = partida.verificarJogada(jogadorPessoa.fazJogada(), nomeJogador, tabuleiroJogador, tabuleiroComputador, tabuleiro);
         ...
         placarMaquina =partida.verificarJogada(jogadorMaquina.fazJogada(), "COMPUTADOR", tabuleiroComputador, tabuleiroJogador, tabuleiro);
            exibirPlacar(placarMaquina,nomeJogador,placarPessoa);
            existeGanhador = partida.verificaSeHouveGanhador(jogadorPessoa, jogadorMaquina);
